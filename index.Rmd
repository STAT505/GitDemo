...
- R is currently on version 4.0.2, if your version is much older than this (3.X.X), you will want to update it [here](https://cloud.r-project.org).
...
- If you are leery of using the command line, now that R Studio has some point and click options. 

- Otherwise, two options are options are:
