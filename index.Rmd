...
Here are 6 basic steps to set up Github to interface with R Studio.
...
- R is currently on version 4.1.1, if your version is much older than this (3.X.X), you will want to update it [here](https://cloud.r-project.org).
...
- If you are leery of using the command line, now that R Studio has a nice interface with Git that includes point and click options. 

- Otherwise, GitHub has a desktop options are options are:
